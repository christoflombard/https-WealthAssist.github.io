  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (isWebGL2) {
        ...
        formatRGBA = getSupportedFormat(gl as any, gl.RGBA, gl.RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(gl as any, gl.RGBA, gl.RGBA, halfFloatTexType);
        formatR = getSupportedFormat(gl as any, gl.RGBA, gl.RGBA, halfFloatTexType);
      }
